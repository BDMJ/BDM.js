...
const WorkerPool = require("BDM.js/package/handlers/workerPool");
const searchIndexes = require("BDM.js/package/handlers/KMP");
const Lavalink = require("BDM.js/package/classes/Lavalink");
const interpreter = require("BDM.js/package/interpreter");

const Interaction = require("BDM.js/package/classes/Interaction");
const CustomEvent = require("BDM.js/package/classes/customEvent");
const opts = require("BDM.js/package/utils/options");
const API = require("BDM.js/package/handlers/boosterAPI");
...
const shardingClient = require("BDM.js/package/handlers/shardingClient");
...
const ForceDisconnect = require("BDM.js/package/handlers/ForceDisconnect");
...
const InteractionCreate = require("BDM.js/package/events/interactionCreate");
const InviteCreate = require("BDM.js/package/events/inviteCreate");
const InviteDelete = require("BDM.js/package/events/inviteDelete");
const GuildBanAdd = require("BDM.js/package/events/guildBanAdd");
const GuildBanRemove = require("BDM.js/package/events/guildBanRemove");
const MusicStart = require("BDM.js/package/events/musicStart");
const MusicEnd = require("BDM.js/package/events/musicEnd");
const GuildCreate = require("BDM.js/package/events/guildCreate");
const GuildDelete = require("BDM.js/package/events/guildDelete");
const MessageUpdate = require("BDM.js/package/events/messageUpdate");
const ChannelPinsUpdate = require("BDM.js/package/events/channelPinsUpdate");
const webhookUpdate = require("BDM.js/package/events/webhookUpdate");
const MessageDeleteBulk = require("BDM.js/package/events/messageDeleteBulk");
const Message = require("BDM.js/package/events/message");
const Ready = require("BDM.js/package/events/ready");
const MessageDelete = require("BDM.js/package/events/messageDelete");
const GuildMemberAdd = require("BDM.js/package/events/guildMemberAdd");
const GuildMemberRemove = require("BDM.js/package/events/guildMemberRemove");
const MessageReactionAdd = require("BDM.js/package/events/messageReactionAdd");
const MessageReactionRemove = require("BDM.js/package/events/messageReactionRemove");

const CustomError = require ("BDM.js/package/handlers/errorCommands");
const VarCreate = require("BDM.js/package/handlers/variableCreateCommands");
const VarUpdate = require("BDM.js/package/handlers/variableUpdateCommands");
const VarDelete = require("BDM.js/package/handlers/variableDeleteCommands");
const AppCmdCreate = require("BDM.js/package/handlers/applicationCreateCommands");
const CheckGlobalSlashCreate = require("BDM.js/package/handlers/checkGlobalSlashCreate");
const CheckSlashUpdate = require("BDM.js/package/handlers/checkSlashUpdate");
const AppCmdUpdate = require("BDM.js/package/handlers/applicationUpdateCommands");
const AppCmdDelete= require("BDM.js/package/handlers/applicationDeleteCommands");

require("BDM.js/package/handlers/UpdateWarning")();
const parser = require("BDM.js/package/functions/parser");
/**
   ...
   options: options 
    ...
    if (options.typingStopEvent)
      client.on("typingStart", (channel, user) =>
        require("BDM.js/package/handlers/typingStopHandling")(client, channel, user)
      );
    ...
    if (options.autoUpdate) {
      require("BDM.js/package/handlers/AutoUpdate")();
    }
    ...
    client.on("timeoutPulse", (data) =>
      require("BDM.js/package/events/timeoutExpire")(client, data, true)
    );
    client.on("timeoutExpire", (data) =>
      require("BDM.js/package/events/timeoutExpire")(client, data)
    );
...
functionErrorCommand(d = {}) {
  ...
  loopCommand(
    ...
    const interval = require("BDM.js/package/handlers/loopCommands")(client, opts);
  ...
  async loadCommands(path, debug = true) {
    ...
    for (const { name } of dirents) {
      ...
      for (const cmd of cmds) {
        ...
        debugs.push(`| Command charged:  '${cmd.name || cmd.channel}' (${cmd.type})`);
      }
    }
  ...
  onMemberUpdate() {
    client.on("guildMemberUpdate", (oldm, newm) => {
      require("BDM.js/package/events/guildMemberUpdate")(client, oldm, newm);
    });
  }
  //not accurate, might need a few seconds to detect the user, and must be enable within bot instance
  onTypingStop() {
    client.on("typingStop", (channel, user) =>
      require("BDM.js/package/events/typingStop")(client, channel, user)
    );
  }

  onRateLimit() {
    client.on("rateLimit", (info) => {
      require("BDM.js/package/events/rateLimit")(client, info);
    });
  }
  ...
  onTypingStart() {
    ...
    client.on("typingStart", (channel, user) =>
      require("BDM.js/package/events/typingStart")(client, channel, user)
    );
  }

  onVoiceStateUpdate() {
    client.on("voiceStateUpdate", (olds, news) => {
      require("BDM.js/package/events/voiceStateUpdate")(client, olds, news);
    });
  }
  
  onChannelDelete() {
    client.on("channelDelete", (channel) =>
      require("BDM.js/package/events/channelDelete")(client, channel)
    );
  }

  onChannelCreate() {
    client.on("channelCreate", (channel) =>
      require("BDM.js/package/events/channelCreate")(client, channel)
    );
  }

  onChannelUpdate() {
    client.on("channelUpdate", (oldc, newc) =>
      require("BDM.js/package/events/channelUpdate")(client, oldc, newc)
    );
  }
  
  onMessageDeleteBulk() {
    client.on("messageDeleteBulk", (bulk) => {
      require("BDM.js/package/events/messageDeleteBulk")(client, bulk);
    });
  }
  
  onGuildUpdate() {
    client.on("guildUpdate", (oldg, newg) =>
      require("BDM.js/package/events/guildUpdate")(client, oldg, newg)
    );
  }
  ...
  onChannelPinsUpdate() {
    client.on("channelPinsUpdate", (pinch) =>
      require("BDM.js/package/events/channelPinsUpdate")(client, pinch)
    );
  }
  ...
  onWebhookUpdate() {
    client.on("webhookUpdate", (whc) =>
      require("BDM.js/package/events/webhookUpdate")(client, whc)
    );
  }
    
  onEmojiUpdate() {
    client.on("emojiUpdate", (olde, newe) =>
      require("BDM.js/package/events/emojiUpdate")(client, olde, newe)
    );
  }
  
   onEmojiDelete() {
    client.on("emojiDelete", (emoji) =>
      require("BDM.js/package/events/emojiDelete")(client, emoji)
    );
  }
  
  onEmojiCreate() {
    client.on("emojiCreate", (emoji) =>
      require("BDM.js/package/events/emojiCreate")(client, emoji)
    );
  }
  
  onRoleUpdate() {
    client.on("roleUpdate", (oldr, newr) =>
      require("BDM.js/package/events/roleUpdate")(client, oldr, newr)
    );
  }

  onRoleDelete() {
    client.on("roleDelete", (role) =>
      require("BDM.js/package/events/roleDelete")(client, role)
    );
  }

  onRoleCreate() {
    client.on("roleCreate", (role) =>
      require("BDM.js/package/events/roleCreate")(client, role)
    );
  }
  onPresenceUpdate() {
    client.on("presenceUpdate", (oldp, newp) =>
      require("BDM.js/package/events/presenceUpdate")(client, oldp, newp)
    );
  }
  onUserUpdate() {
    client.on("userUpdate", (old, newu) =>
      require("BDM.js/package/events/userUpdate")(client, old, newu)
    );
  }
