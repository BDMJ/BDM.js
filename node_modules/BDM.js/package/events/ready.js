...
module.exports = async (client, Database) => {
  ...
  if (client.options.fetchInvites)
    await new Promise(async (resolve) => {
      ...
      }); //Copyright © DBD.JS by DBD.JS Team (i have retake the system owo)
  ...
  console.log("BDM.js is ready :3");
  console.log(
    "Join our discord server for getting help: https://discord.gg/wHakuCz2us"
  );
